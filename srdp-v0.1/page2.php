...
<div class="am-g am-g-fixed my-page">
  <div class="am-u-md-9 am-u-md-push-3">
    ...
    $page_id = 1485;
    $page_data = get_page( $page_id );
    $four_title = $page_data->post_title;
    $four_page = apply_filters('the_content', $page_data->post_content);

    $page_id = 1487;
    $page_data = get_page( $page_id );
    $five_title = $page_data->post_title;
    $five_page = apply_filters('the_content', $page_data->post_content);
  ?>
    ...
    <div class="am-offcanvas" id="sidebar">
      <div class="am-offcanvas-bar">
        <ul class="am-nav">
          ...
          <li><a href="/?page_id=1471">会员注册</a></li>
          <li class="am-active"><a href="/?page_id=1479">推广产品</a></li>
